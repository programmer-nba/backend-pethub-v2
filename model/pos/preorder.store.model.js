...
const PreOrderStoreSchema = new mongoose.Schema({
...
const PreOrderStores = mongoose.model("preorder_store", PreOrderStoreSchema);
...
module.exports = { PreOrderStores, validate };
